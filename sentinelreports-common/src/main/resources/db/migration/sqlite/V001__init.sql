...
CREATE INDEX IF NOT EXISTS idx_reports_reporter_uuid ON reports(reporter_uuid);
CREATE INDEX IF NOT EXISTS idx_reports_target_uuid ON reports(target_uuid);
CREATE INDEX IF NOT EXISTS idx_reports_status ON reports(status);
CREATE INDEX IF NOT EXISTS idx_reports_priority ON reports(priority);
CREATE INDEX IF NOT EXISTS idx_reports_category ON reports(category);
CREATE INDEX IF NOT EXISTS idx_reports_server_name ON reports(server_name);
CREATE INDEX IF NOT EXISTS idx_reports_created_at ON reports(created_at);
CREATE INDEX IF NOT EXISTS idx_reports_assigned_to_uuid ON reports(assigned_to_uuid);
